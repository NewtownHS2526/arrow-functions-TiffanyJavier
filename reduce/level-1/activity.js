...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Result1.reduce((acc, word) => acc + " " + word, "");
...
console.log("Example 3 - Regular:", exercise3Result2.trim());
...
// Your solution here (one-line arrow function):
const exercise4Result1 = exercise4Result1.reduce((acc, n) => n > acc ? n : acc, numbers2[0]);
